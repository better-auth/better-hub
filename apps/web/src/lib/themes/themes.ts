...
export const vesper: ThemeDefinition = {
	id: "vesper",
	name: "Vesper",
	description: "Peppermint and orange, sophisticated dark",
	mode: "dark",
	...
	colors: {
		...
		"--line-gutter": "#505050",
		"--line-highlight": "rgba(255, 199, 153, 0.06)",
		"--search-highlight": "rgba(255, 199, 153, 0.10)",
		"--search-highlight-active": "rgba(255, 199, 153, 0.20)",
		...
		"--diff-word-add": "rgba(153, 255, 228, 0.20)",
		"--diff-word-del": "rgba(255, 128, 128, 0.20)",
		"--alert-note": "#ffc799",
		"--alert-tip": "#99ffe4",
		"--alert-important": "#bd93f9",
