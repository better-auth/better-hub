...
export default async function DashboardPage() {
	...
	const {
		...
		openPRCategories: async () =>
			await getDashboardOpenPRCategories(githubUser.login, 30),
		myIssues: async () =>
			await searchIssues(`is:issue is:open assignee:${githubUser.login}`, 10),
