 ...
 *
 * Usage:
 *   pnpm sync:models          # generate / update the file
 *   pnpm sync:models:check    # exit 1 if the file would change (CI)
 */
...
async function main() {
	...
	const content = [
		`// This file is auto-generated by apps/web/scripts/sync-model-pricing.ts`,
		`// Do not edit manually — run: pnpm sync:models`,
		``,
	...
	if (checkOnly) {
		if (!existsSync(OUT_PATH)) {
			console.error(
				"openrouter-models.generated.ts does not exist. Run pnpm sync:models.",
			);
			process.exit(1);
		}
		...
		if (existing === content) {
			...
			console.error(
				"Model pricing is out of date. Run pnpm sync:models to update.",
			);
			process.exit(1);
		}
	}
